...
import com.tkevinb.ragent.rag.core.intent.IntentNode;
...
import static com.tkevinb.ragent.rag.constant.RAGConstant.*;
...
public class RAGPromptService {
    ...
    /**
     * 构建传给 LLM 的完整消息列表：历史会话 + evidence(mcp/kb) + 用户问题 + 系统提示词
     */
    public List<ChatMessage> buildStructuredPrompt(PromptContext context,
